...
\chapter{Social Network Analysis}
	...
	Il belonging coefficient nel caso di AVPRA rappresenta una misura di diffusione/accumulo delle ettichete dei nodi, dipendente dalla distanza rispetto ad altri nodi e la loro frequenza. \cite{avpra} 
		...
		\begin{center}
			\begin{figure}[H]
				\centering
				\subfloat[\centering Vettore ettichete del nodo 1 a tempo 0]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node1vlt0}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 2 a tempo 0] {{\includegraphics[width=0.2\linewidth,keepaspectratio]{node2vlt0}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 3 a tempo 0]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node3vlt0}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 4 a tempo 0]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node4vlt0}}}
		...
		\begin{center}
			\begin{figure}[H]
				\centering
				\subfloat[\centering Vettore ettichete del nodo 1 a tempo 1]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node1vlt1}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 2 a tempo 1] {{\includegraphics[width=0.2\linewidth,keepaspectratio]{node2vlt1}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 3 a tempo 1]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node3vlt1}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 4 a tempo 1]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node4vlt1}}}

				\caption{Vettori di ettichete a tempo 1}
			\end{figure}
		\end{center}
		...
		\begin{center}
			\begin{figure}[H]
				\centering
				\subfloat[\centering Vettore ettichete del nodo 1 a tempo 2]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node1vlt2}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 2 a tempo 2] {{\includegraphics[width=0.2\linewidth,keepaspectratio]{node2vlt2}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 3 a tempo 2]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node3vlt2}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 4 a tempo 2]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node4vlt2}}}

				\caption{Vettori di ettichete a tempo 2}
			\end{figure}
		\end{center}
		...
		\begin{center}
			\begin{figure}[H]
				\centering
				\subfloat[\centering Vettore ettichete del nodo 1 a tempo 3]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node1vlt3}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 2 a tempo 3] {{\includegraphics[width=0.2\linewidth,keepaspectratio]{node2vlt3}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 3 a tempo 3]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node3vlt3}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 4 a tempo 3]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node4vlt3}}}

				\caption{Vettori di ettichete a tempo 3}
			\end{figure}
		\end{center}
		...
		\begin{center}
			\begin{figure}[H]
				\centering
				\subfloat[\centering Vettore ettichete del nodo 1 a tempo 4]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node1vlt4}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 2 a tempo 4] {{\includegraphics[width=0.2\linewidth,keepaspectratio]{node2vlt4}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 3 a tempo 4]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node3vlt4}}}
				\qquad
				\subfloat[\centering Vettore ettichete del nodo 4 a tempo 4]{{\includegraphics[width=0.2\linewidth,keepaspectratio]{node4vlt4}}}
